...
INSERT INTO `companies` (`id`, `corporate_name`, `trade_name`, `state_registration`, `cnpj`, `phone`, `email`, `is_active`, `address_id`, `created_at`, `updated_at`) VALUES
	(1, 'PREFEITURA MUNICIPAL DE NOVA MUTUM', 'PREFEITURA MUNICIPAL DE NOVA MUTUM', NULL, '24772162000106', '', '', 1, 1, '2025-05-13 01:23:40', '2025-05-13 01:23:40');
...
-- Copiando dados para a tabela chamadosv2.permissions: ~24 rows (aproximadamente)
...
-- Copiando dados para a tabela chamadosv2.roles: ~2 rows (aproximadamente)
DELETE FROM `roles`;
...
-- Copiando dados para a tabela chamadosv2.role_has_permissions: ~13 rows (aproximadamente)
...
-- Copiando dados para a tabela chamadosv2.users: ~2 rows (aproximadamente)
DELETE FROM `users`;
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `remember_token`, `created_at`, `updated_at`, `company_id`) VALUES
	(2, 'Gerente', 'gerente@gerente.com', NULL, '$2y$12$NQI9N4Diu382LhL2zgszLOzKqPK1WA3piZwZDKRy/2LgnxSCpT8P.', NULL, '2025-05-12 21:48:57', '2025-05-12 21:48:57', NULL),
	(3, 'teste', 'teste@gmail.com', NULL, '$2y$12$.CMkycBeSFlxN9fp.83/mecmAw0lNsQD.Vm1llrL2erKpu/RSsXJu', NULL, '2025-05-12 22:21:58', '2025-05-12 22:21:58', NULL),
	(6, 'JEOVÁ OLIVEIRA DOS SANTOS', 'jeovacnp2012@gmail.com', NULL, '$2y$12$Z66hGGLlHi6WK9rxTsP.O..lu7nuDt/eRDpy32CNrUc7RIxCjxmau', NULL, '2025-05-13 01:13:51', '2025-05-13 01:13:51', NULL);
